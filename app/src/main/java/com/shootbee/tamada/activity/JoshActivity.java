...
import com.shootbee.tamada.databinding.ActivityJoshBinding;
...
import static com.shootbee.tamada.util.Utils.ROOTDIRECTORYJOSH;
...
public class JoshActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        binding.LLOpenJosh.setOnClickListener(v -> {
